...
python moe_prune/eval_ppl.py --score-mode l1 --layer-mode one_layer --model ${model_path}
...
# prune by random
python moe_prune/eval_ppl.py --score-mode random --layer-mode jump_layers --model ${model_path}
