...
parser.add_argument("--num-expert", type=int, default=60, help="默认为qw16B专家数")
...
output_dict = {"expert_idxs": [],
               ...
               "expert_num": []}
try:
    while (len(prune_expert_idx_list) < 4):  # extra expert num = 4
        print("the {}th iteration".format(len(prune_expert_idx_list)))
        candidate_expert_idx_list = [expert for expert in range(60)
