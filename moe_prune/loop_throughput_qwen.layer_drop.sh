...
for prune_expert_num in 0 4;do
    for prune_layer_num in 0 3 6 9 12 15; do
        ...
        hyper="prune_layer_num=${prune_layer_num};num_route_experts=${prune_expert_num};trim_layer_num=0"
        echo $hyper
...
for prune_expert_num in 0;do
    for prune_layer_num in 3 6 9 12 15; do
        eval_log=qwen_model/logs_throughput/layer_drop.e${prune_expert_num}.l${prune_layer_num}.log
        hyper="prune_layer_num=0;num_route_experts=${prune_expert_num};trim_layer_num=${prune_layer_num}"
        echo $hyper
        echo $hyper > $hyper_file
